...
public class MatchSessionManager {
    private final java.util.Map<java.util.UUID, Session> byA = new java.util.HashMap<>();
    private final java.util.Map<java.util.UUID, Session> byB = new java.util.HashMap<>();
    ...
    public java.util.Collection<Session> all(){
        java.util.Set<Session> set = new java.util.HashSet<>();
        set.addAll(byA.values()); set.addAll(byB.values());
        return set;
    }
    public Session findByPlayer(java.util.UUID id){
        Session s = byA.get(id);
        if (s != null) return s;
        return byB.get(id);
    }
