...
public class UltimatePixelmonRatingPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        this.detector = new BattleResultDetector(this, ratings);
        ...
        chatParseListener = new ChatParseListener(this);
        ...
        getLogger().info("UltimatePixelmonRating v" + getDescription().getVersion() + " enabled.");
    }

    @Override
    public void onDisable() {
        try { if (protocolHook != null) protocolHook.shutdown(); } catch (Throwable ignored) {}
        try { if (watchdog != null) watchdog.stop(); } catch (Throwable ignored) {}
